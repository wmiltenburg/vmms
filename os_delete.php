    ...
    if(isset($_GET['username']) && isset($_GET['session']) && isset($_GET['user'])){
        ...
        if($database->affectedRows() == 1){
            ...
            if($database->affectedRows() == 1){
                ...
                echo "OS exists and trying to delete it from the database <br />";

            $query = sprintf("DELETE FROM os_dir WHERE os = '$os'");
            $database->doQuery($query);

            echo "OS $os is deleted from the database <br/>";
