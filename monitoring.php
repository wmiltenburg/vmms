...
//Check if the $username matches with the $session
        ...
        if($database->affectedRows() == 1){
			...
			echo "			<li><a href=\"./monitoring.php?username=$username&session=$session\">
   							 <INPUT TYPE=\"button\" VALUE=\"Home\" Class=\"knop\">
						</a></li>

						<li><a href=\"./mon_tactical.php?username=$username&session=$session\">
...
//IFrame voor nagios
			   	...
			   	echo " <iframe name=frame 1 src=\"/nagios\" scrolling=\"auto\" width=\"970\" height=\"800\" >
